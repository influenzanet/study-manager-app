        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Om te kijken naar verschillend tussen leeftijdsgroepen."],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "We hopen onderzoek te doen naar de regionale verspreiding van infecties"],
...
const q4_def = (itemSkeleton: SurveyItem): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["de", "Wat is uw voornaamste bezigheid overdag? Ga uit van de normale situatie (dus zonder eventuele corona maatregelen)"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Met deze informatie kunnen we zien of ons cohort wel representatief is voor de bevolking"],
...
const q4cNL_def = (itemSkeleton: SurveyItem, q4Key: string): SurveyItem => {
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["de", "Selecteer het antwoord die het best uw sitautie beschrijft."],
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        ...
        },
        {
            key: '4', role: 'option',
            content: new Map([
                ["nl","Detailhandel (supermarkt, en andere verkoop in winkels)"],
            ])
        },
        {
            key: '5', role: 'option',
            content: new Map([
                ["nl","Werk in het openbaar vervoer (bijv. trein/bus/metro/taxi)"],
            ])
        },
        {
            key: '6', role: 'option',
            content: new Map([
                ["nl","Overig kenniswerk (manager,onderzoeker,accountant)"],
            ])
        },
        {
            key: '7', role: 'option',
            content: new Map([
                ["nl","Administratiefwerk (administratie, financieel assistent,receptionist etc.)"],
            ])
        },
        {
            key: '8', role: 'option',
            content: new Map([
                ["nl","Technisch werk (uitvoerend in Techniek/Bouw/Productie)"],
            ])
        },
        {
            key: '9', role: 'option',
            content: new Map([
                ["nl","Anders uitvoerend werk"],
            ])
        },
        {
            key: '10', role: 'option',
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        {
            key: '0', role: 'option',
            content: new Map([
              ["nl","Kinderdagverblijf/peuterspeelzaal"],               
            ])
        },
        {
            key: '1', role: 'option',
            content: new Map([           
                ["nl", "Basisonderwijs of BSO"],
            ])
        },
        {
            key: '2', role: 'option',
            content: new Map([
                ["nl","Voortgezet onderwijs (VMBO/Havo/VWO"],
            ])
        },
        {
            key: '3', role: 'option',
...
const q4cNLc_def = (itemSkeleton: SurveyItem, q4cNLKey: string): SurveyItem => {
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        ...
        },
        {
            key: '3', role: 'option',
            content: new Map([
                ["nl","Geestelijke gezondheidszorg/zorgverlening"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        },
        {
            key: '5', role: 'option',
            content: new Map([
                ["nl","Andere eerstelijnszorg (bijv. fysiotherapie)"],
            ])
        }, 
        {
            key: '6', role: 'input',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "We willen weten hoe representatief het cohort is ten opzichte van de populatie van Nederland"],
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["nl", "Ik heb geen officiële dimploma's of alleen lager onderwijs"],
...
const q5_def = (itemSkeleton: SurveyItem): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["nl", "Heeft u tijdens een normale dag (dus zonder corona maatregelen) contact met: (meerdere antwoorden mogelijk/ en laat openbaar vervoer buiten beschouwing)"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Om uit te zoeken of contact met deze groepen het risico op klachten beinvloed"],
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Voor groepen mensen kan het gaan om elke situatie waar er contact is met meerdere personen tegelijk"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Ga uit van de normale situatie en uw meest gangbare - dagelijkse - mannier van verplaatsen"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["de", "Denk aan een typische dag. Als u verschillende vormen van openbaar vervoer gebuikt tel dan de duur bijelkaar op."],
...
const q9_def = (itemSkeleton: SurveyItem): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["nl", "Heeft u in het griepseizoen van twee jaar geleden (2018/2019) een griepprik gehaald?"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "We willen de beschermende werking van het vaccine onderzoeken"],
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Zeg ja wanneer u het vaccine heeft ontvangen. Normaal ontvang je een griepprik in het najaar."],
...
const q10_def = (itemSkeleton: SurveyItem): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["nl", "Heeft u het afgelopen griepseizoen (2019/2020) een griepprik gehaald?"],
...
const q10c_def = (itemSkeleton: SurveyItem, q10Key: string): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["nl", "Wat waren voor u de belangrijkste redenen om afgelopen jaar een griepprik te halen?"],
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["nl", "Ik behoor tot een risicogroep (zwanger, 60 jaar of ouderm, chronische ziekte)"],
...
const q10d_def = (itemSkeleton: SurveyItem, q10Key: string): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["nl", "Wat was de reden waarom u zich niet liet vaccineren in het afgelopen griepseizoen(2019/2020)?"],
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["nl", "Ik twijfel aan de effectiviteit van het griepvaccine"],
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["nl", "Ik geloof dat het vaccine ook griep kan veroorzaken"],
            ...
            content: new Map([
                ...
                ["nl", "Ik ben bang dat het vaccine niet veilig is, en me juist ziek maakt of andre neveneffecten heeft"],
            ...
            content: new Map([
                ...
                ["nl", "Ondanks dat mijn huisarts het griepvaccine adviseerde, heb ik het niet genomen"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Het gaat ons alleen om regelmatig gebruik van medicatie, niet om af en toe. Het af en toe gebruiken van een inhaler bij astma valth hier bijvoorbeeld buiten."],
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        {
            ...
            content: new Map([
                ["en", "No"],
                ["de", "Nein"],
                ["de", "Nee, voor geen van de onderstaande aandoeningen"],
                ["fr", "Non"],
            ])
        },
        {
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["nl", "Dagelijks, maar wel minder dan 10 keer per dag"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["nl", "Meerdere antwoorden mogelijk, tick alle opties die relevant zijn"],
