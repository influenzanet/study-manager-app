...
import { getATTACKAL, getAUFM1, getAUFM2, getIMAGEAB, getIMAGEAL, getIMAGEOS, getKANZLER, getPROB1, getKPROB1, getPROB2, getKPROB2, getREZEPT, getSKPART, getSKPOL, getSWABS, getWABS, getWBT, getWK, getWKINT, getWPERF, getWSTRATAB, getWSTRATAL, getWSTRATOS, getSYNC1, getSYNC2, getSYNC3, getATTACKOS, getATTACKAB, getJSTRATLZ, getJSTRATCB, getBIASLZ, getBIASCB } from "./question_pool/questions";
