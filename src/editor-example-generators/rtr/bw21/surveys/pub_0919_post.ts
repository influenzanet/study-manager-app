...
import { getAUFM1, getAUFM2, getKANZLER, getPROB1, getKPROB1, getREZEPT, getSKPART, getSKPOL, getWABS, getWBT, getWK, getWPERF, getWSTRATAB, getWSTRATAL, getWSTRATOS, getBIASLZ, getBIASCB } from "./question_pool/questions";


export const generate_PUB0919POST = (): Survey | undefined => {
    const surveyKey = surveyKeys.PUB_0919_POST;
