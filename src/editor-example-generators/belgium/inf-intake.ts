...
const intake = (): Survey | undefined => {
    ...
    const Q_additional_covid19_questions_hospital_length = additional_covid19_questions_hospital_length(rootKey, Q_previous_covid19_episode.key, Q_additional_covid19_questions_hospital.key, false);
    survey.addExistingSurveyItem(Q_additional_covid19_questions_hospital_length, rootKey);

    const Q_additional_covid19_questions_ICU = additional_covid19_questions_ICU(rootKey, Q_previous_covid19_episode.key, Q_additional_covid19_questions_hospital.key, false);
    survey.addExistingSurveyItem(Q_additional_covid19_questions_ICU, rootKey);

    const Q_additional_covid19_questions_coma = additional_covid19_questions_coma(rootKey, Q_previous_covid19_episode.key, Q_additional_covid19_questions_hospital.key, false);
    ...
    const Q_additional_covid19_questions_ongoing_symptoms = additional_covid19_questions_ongoing_symptoms(rootKey, Q_previous_covid19_episode.key, Q_additional_covid19_questions_returned_health.key, false);
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Attending daycare, school, college or university"],
            ])
        },
        {
            key: '4', role: 'option',
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "The hotel and restaurant sector"],
            ])
        },
        {
            key: '8', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Agriculture, hunting and forestry"],
            ])
        },
        {
            key: '10', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Real estate, property rental"],
            ])
        },
        {
            key: '12', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Production and distribution of electricity, water and gas"],
            ])
        },
        {
            key: '14', role: 'option',
            content: new Map([
                ...
                ["en", "Repair of automotive vehicles and household appliances"],
            ])
        },
        {
            key: '15', role: 'option',
            content: new Map([
                ...
                ["en", "Sociocultural and personnel services"],
            ])
        },
        {
            key: '16', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "In order to better identify participants who have regular contact with children/adolescents."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["en", "I work in a daycare facility/nursery school"],
            ])
        },
        {
            key: '1', role: 'option',
            content: new Map([
                ...
                ["en", "I work in primary education"],
            ])
        },
        {
            key: '2', role: 'option',
            content: new Map([
                ...
                ["en", "I work in secondary education"],
            ])
        },
        {
            key: '3', role: 'option',
            content: new Map([
                ...
                ["en", "I work in tertiary education (example: a college or university)"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "In order to better identify participants who work in the healthcare sector."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "I work in a rehabilitation centre"],
            ])
        },
        {
            key: '2', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "I work in the mental health and mental healthcare field"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "I work in another primary care service (for example: physiotherapy or rehabilitation)"],
            ])
        },
        {
            key: '6', role: 'option',
            content: new Map([
                ...
                ["en", "I work in a specialist medical office"],
            ])
        },
        {
            key: '7', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "In order to examine the representativeness of our cohort (the group of participants in this study) compared to the population."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "Select the answer that matches the highest level of education you have successfully completed."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["en", "I have no formal qualifications"],
            ])
        },
        {
            key: '11', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "In order to determine whether you may be more exposed to the viruses than the average person (for example, by working with children or with patients)."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "Groups of people can include any situation where you are in contact with a large number of people (for example, a teacher who may be in contact with many children in a day)."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["en", "More than 10 children under 3 years of age"],
            ])
        },
        {
            key: '11', role: 'option',
            ...
            content: new Map([
                ...
                ["en", "More than 10 children between 3 and 11 years of age"],
            ])
        },
        {
            key: '12', role: 'option',
            ...
            content: new Map([
                ...
                ["en", "More than 10 teenagers between 12 and 17 years of age"],
            ])
        },
        {
            key: '13', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Groups of more than 10 individuals (excluding children and people over 65)"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "The composition of the household could influence the risk of infection, which we want to study."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "A household is defined as a group of people (not necessary family members) who live at the same address, and share the kitchen, living room, family room or dining room."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "This question will allow us to study conditions that are linked to an elevated risk of infection."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Yes, for chronic lung disorder besides asthma (e.g. COPD, emphysema)"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Yes, for an immunocompromising condition from treatment or illness including splenectomy, organ transplant, acquired immune deficiency, cancer treatment"],
            ])
        },
        {
            key: '7', role: 'input',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "Smoking tobacco is a risk factor for severe respiratory disease. We would like to carry out research on this topic."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "Please answer as precisely as possible."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "I am ex-smoker (smoked for 5 years or less)"],
            ])
        },
        {
            key: '12', role: 'option',
            content: new Map([
                ...
                ["en", "I am ex-smoker (smoked for more than 5 years)"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "We want to know whether diet can be linked to the risk of infection."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "Multiple responses are possible, mark all that apply."],
                ]),
            },
        ])
    );
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "I follow a diet as a result of allergies and/or food intolerance"],
            ])
        },
        {
            key: '4', role: 'input',
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "The internet (a website, an informational website, a search engine) excluding social media"],
            ])
        },
        {
            key: '11', role: 'option',
            content: new Map([
                ...
                ["en", "Social media (Facebook, Twitter, Instagram, etc.)"],
            ])
        },
        {
            key: '4', role: 'option',
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "We need background information regarding previous coronavirus infections."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
...

        {
            ...
            content: new Map([
                ...
                ["en", "Yes, maybe, I had/have symptoms that resemble those of the coronavirus"],
            ])
        },
        {
            key: '3', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Yes, I am almost certain, because me and people around me had/have symptoms that resemble those of the coronavirus, and one or more of those people tested positive for coronavirus"],
            ])
        },
        {
            key: '5', role: 'option',
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Yes, I am certain, because I tested positive for coronavirus, but have not experienced any symptoms"],
            ])
        },
    ]);
    editor.addExistingResponseComponent(rg_inner, rg?.key);
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "We would like to know the most frequent symptoms linked to a coronavirus infection."],
                ]),
                style: [{ key: 'variant', value: 'p' }],
            },
            {
    ...
    const rg_inner = initMultipleChoiceGroup(multipleChoiceKey, [
        ...
        },
        {
            ...
            content: new Map([
                ...
                ["en", "Muscle/joint pain (not sport related)"],
            ])
        },
        {
            key: '10', role: 'option',
    ...
    editor.setTitleComponent(
        generateTitleComponent(
            ...
            new Map([
                ...
                ["en", "(It will take about 2-5 minutes of your time)"]
            ]),
        )
    );
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "We wish to collect more information regarding the medical care you required due to your coronavirus infection."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
    ...
    const rg_inner = initSingleChoiceGroup(singleChoiceKey, [
        {
            ...
            content: new Map([
                ...
                ["en", "Yes, and the doctor said I had definitely caught the coronavirus"],
            ])
        },
        {
            key: '1', role: 'option',
            content: new Map([
                ...
                ["en", "Yes, and the doctor said I might have caught the coronavirus"],
            ])
        },
        {
            key: '2', role: 'option',
            content: new Map([
                ...
                ["en", "Yes, and the doctor said I had definitely not caught the coronavirus"],
            ])
        },
        {
            key: '3', role: 'option',
 ...
 * @param keyOverride use this to override the default key for this item (only last part of the key, parent's key is not influenced).
 */
const additional_covid19_questions_hospital_length = (parentKey: string, keyprevious_covid19_episode?: string, keyadditional_covid19_questions_hospital?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
 ...
 * @param keyOverride use this to override the default key for this item (only last part of the key, parent's key is not influenced).
 */
const additional_covid19_questions_ICU = (parentKey: string, keyprevious_covid19_episode?: string, keyadditional_covid19_questions_hospital?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
 ...
 * @param keyOverride use this to override the default key for this item (only last part of the key, parent's key is not influenced).
 */
const additional_covid19_questions_coma = (parentKey: string, keyprevious_covid19_episode?: string, keyadditional_covid19_questions_hospital?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["en", "We wish to collect more information regarding the medical impact due to your coronavirus infection."],
                ]),
                // style: [{ key: 'variant', value: 'p' }],
            },
        ])
 ...
 * @param keyOverride use this to override the default key for this item (only last part of the key, parent's key is not influenced).
 */
const additional_covid19_questions_ongoing_symptoms = (parentKey: string, keyprevious_covid19_episode?: string, keyadditional_covid19_questions_returned_health?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
