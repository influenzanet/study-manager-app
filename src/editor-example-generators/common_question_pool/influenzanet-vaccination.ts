...
const vaccineBrand = (parentKey: string, keyvac?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["it", "Which COVID-19 vaccine did you receive?"],
...
const vaccineShots = (parentKey: string, keyvac?: string, isRequired?: boolean, keyOverride?: string): SurveyItem => {
    ...
    editor.setTitleComponent(
        generateTitleComponent(new Map([
            ...
            ["it", "How many doses of the vaccine did you receive?"],
        ...
        generateHelpGroupComponent([
            ...
            },
            {
                content: new Map([
                    ...
                    ["it", "We would like to be able to work out how much protection a complete vaccination scheme gives."],
            ...
            },
            {
                content: new Map([
                    ...
                    ["it", "Report the number of doses you received (which corresponds to the number of time you were vaccinated against COVID-19 )."],
