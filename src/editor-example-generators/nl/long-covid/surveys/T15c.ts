...
export const generateT15c = (): Survey | undefined => {
    const surveyKey = surveyKeys.T15c;
    ...
    const surveyEditor = new SimpleSurveyEditor({
        ...
        description: new Map([
            ["nl", "Vijftien maanden geleden ben je gestart met het LongCOVID-onderzoek. Dit is een vervolgvragenlijst. De vragenlijst richt zich op je gezondheid, en zorggebruik."],
        ]),
