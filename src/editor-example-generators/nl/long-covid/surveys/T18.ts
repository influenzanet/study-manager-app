...
export const generateT18 = (): Survey | undefined => {
    const surveyKey = surveyKeys.T18;
    ...
    const surveyEditor = new SimpleSurveyEditor({
        ...
        description: new Map([
            ["nl", "Anderhalf jaar geleden ben je gestart met het LongCOVID-onderzoek. Dit is een vervolgvragenlijst. De vragenlijst richt zich op je gezondheid, vaccinaties en zorggebruik."],
        ]),
