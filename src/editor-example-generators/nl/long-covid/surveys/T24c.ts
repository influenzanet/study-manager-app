...
export const generateT24c = (): Survey | undefined => {
    ...
    const surveyEditor = new SimpleSurveyEditor({
        ...
        description: new Map([
            ["nl", "Twee jaar geleden ben je gestart met het LongCOVID-onderzoek. Dit is een vervolgvragenlijst. De vragenlijst richt zich op je gezondheid en zorggebruik."],
        ]),
