...
Ben je een ouder/verzorger dan kun je de antwoorden invullen voor/over je kind.
    ...
    Q2(key: string, condition: Expression, isRequired?: boolean) {
        return SurveyItemGenerators.dateInput({
            ...
            minRelativeDate: { delta: { days: -3000 } },
    ...
    Q4ipqpreText(itemKey: string, condition: Expression) {
        return SurveyItemGenerators.display({
            parentKey: this.key,
...
Je hebt hierboven aangegeven dat je afgelopen week klachten had. Onderstaande vragen gaan over alle klachten die je eerder hebt aangegeven, of ze nu wel of niet door het coronavirus komen.`],
    ...
    Q5ipqpreText(itemKey: string, condition: Expression) {
        return SurveyItemGenerators.display({
            parentKey: this.key,
            ...
            content: [
                ComponentGenerators.markdown({
                    content: new Map([
                        ['nl', `
## Klachtenperceptie (ouder/verzorger)
